...
{
    public partial class yardimsever_sil : Form
    {
        ...
        public yardimsever_sil()
        {
            InitializeComponent();
        }

        private void yardimsever_sil_Load(object sender, EventArgs e)
        {
            kayitGetir();
        }
        ...
        private void kayitGetir()
        {
            ...
            conn.Open();
            String yardimsever = "select * from yardimsever";
            NpgsqlCommand komut = new NpgsqlCommand(yardimsever, conn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand cmd = new NpgsqlCommand("delete from yardimsever where kAdi=@kullanici_adi", conn);
